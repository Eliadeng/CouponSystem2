...
import com.johnbryce.CoupSys.service.CompanyService;
...
public class CompanyTesting implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		printUtils.printCompaniesWithOutCoupon();
		...
		printUtils.printOneCompanyWithOutCoupon(adminService.getCompanyByEmailAndPassword("superpharm@gmail.com", "3567"));
